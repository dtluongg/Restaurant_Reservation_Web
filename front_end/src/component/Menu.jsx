    ...
    return (
        <div className="px-4 py-12 max-w-6xl mx-auto ">
            ...
            <div className="text-center mb-8">
                <h2 className="text-2xl font-medium m-4 text-gray-700">Explore Our Categories</h2>
                <ul className="flex flex-wrap justify-center gap-4">
                    {categoryItem.map((item, index) => (
                        <li
                            ...
                            className={`cursor-pointer px-6 py-2 rounded-full font-medium text-sm transition-all duration-200 ${category === item.category_title ? "bg-amber-500" : "bg-gray-200 hover:bg-amber-200"}`}
                        >
                            {item.category_title}
                        </li>
                    ))}
